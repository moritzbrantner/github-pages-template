...
test("generated pages expose theme contrast and locale preferences", async () => {
  ...
  assert.match(overview, /data-preference-id="appearance\.color_scheme"/);
  assert.match(overview, /data-preference-id="appearance\.contrast"/);
  assert.match(overview, /data-preference-id="localization\.locale"/);
  assert.match(overview, />Einstellungen</);
